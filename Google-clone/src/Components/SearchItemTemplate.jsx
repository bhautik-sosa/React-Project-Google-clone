...
export default function SearchItemTemplate({data}) {
  ...
  return (
    <div className='flex flex-col py-3 max-w-[700px]'>
         ...
         <div className="text-sm text-[#4d5156] leading-6 pt-1" dangerouslySetInnerHTML={createMarkUp(data.htmlSnippet)}></div>
    </div>
  )
}
